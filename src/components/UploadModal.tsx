...
export function UploadModal({ onClose, lang, onDataApplied }: UploadModalProps) {
  const isAr = lang === 'ar';
          ...
          <div className="p-6 md:p-8">
            ...
            {fileSelected && (
              <div className="bg-slate-950/40 border border-white/5 rounded-xl p-4 mb-5">
                ...
                {/* Columns breakdown */}
                <div className="text-[10px] text-slate-400 leading-relaxed max-h-16 overflow-y-auto bg-slate-950/50 p-2.5 rounded-lg border border-white/5 font-mono">
            ...
            {fileSelected && (
              <div className="grid grid-cols-2 gap-3 mb-6">
                <button
                  ...
                  className={`flex flex-col items-start p-3 rounded-xl border text-right ltr:text-left transition-all ${
                    mode === 'merge' 
            ...
            <div className="flex gap-2.5">
              ...
              <button
                onClick={onClose}
                className="px-5 py-3.5 bg-white/5 hover:bg-white/10 hover:text-slate-100 hover:border-white/10 text-slate-400 border border-white/5 rounded-xl font-bold text-xs"
              >
                {isAr ? 'إلغاء' : 'Cancel'}
              </button>
            </div>
